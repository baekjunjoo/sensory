...
export default function Home() {
  ...
  const [studioBraille, setStudioBraille] = useState("");
  ...
  useEffect(() => {
    ...
    studioTranslation.mutate({ text, locale: localeForBraille(text) }, {
      onSuccess: (result) => {
        ...
        setStudioBraille(result.braille);
